...
public class ContactoControlador {
	...
	public String actualizarContacto(@PathVariable Integer id,@Validated Contacto contacto,BindingResult bindingResult,RedirectAttributes redirect,Model modelo) {
		...
		contactoDB.setUbi(contacto.getUbi());
		contactoDB.setModelo(contacto.getModelo());
		contactoDB.setPlaca(contacto.getPlaca());
		
		
		contactoRepositorio.save(contactoDB);
		redirect.addFlashAttribute("msgExito", "El registro ha sido actualizado correctamente");
		return "redirect:/";
	}
